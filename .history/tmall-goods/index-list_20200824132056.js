...
(function() {
    ...
    function createModal(text) {
        ...
        dialog.setAttribute("style", "position: fixed; overflow: auto; left: 0px; top: 0px; z-index: 1000; background-color: #FFFFFF; width: 100%; text-align: center;");
    ...
    function parsePage(){
        ...
        if(document.documentElement.scrollHeight - document.documentElement.scrollTop === document.documentElement.clientHeight){
            ...
            var tips = '共有 ' + total + ' 页， 正在获取第 ' + pageNum + ' 页数据, *s后，模拟点击第 ' + (k+1) + ' 条数据';

            myText.innerText = '共有 ' + total + ' 页， 正在获取第 ' + pageNum + ' 页数据, 30s后，模拟点击第 ' + (k+1) + ' 条数据';
                ...
                optimeTimer = setInterval(function(){
                    ...
                    if(k===2){
                        ...
                        if(res){ //
                            ...
                            myText.innerText = '本次get了 ' + (pageNum * 40)  + ' 条数据！3秒后关闭脚本';
                            setTimeout(function() {
