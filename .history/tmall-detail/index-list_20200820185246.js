    ...
    $(()=>{
        ...
        if(document.documentElement.scrollHeight - document.documentElement.scrollTop === document.documentElement.clientHeight){
            ...
            setTimeout(() => {
                ...
                dialog.setAttribute("style", "position: fixed; overflow: auto; padding: 16px; right: 70px; bottom: 10px; z-index: 1000; background-color: #D9EDF7; height: 300px; width: 600px; border: 1px solid #bce8f1; border-radius: 4px;");
